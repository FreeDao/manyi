...
public class EstateController extends BaseController {
	...
	@ResponseBody
	public Response editEstate(EstateRequest req, HttpServletRequest request) {
		return HttpClientHelper.sendRestJsonShortObj2Obj("/rest/estate/editEstate.rest", req,Response.class);
	}
...
//	@RequestMapping(value = "/editEstate")
//	@ResponseBody
//	public String editEstate(EstateRequest req, HttpServletRequest request) {
