...
public class UserManagerController extends RestController{
	...
	public DeferredResult<Response> getUser(@RequestBody getUserRequest request){
		Page<UserResponse> result =  this.getUserManagerService().getUser(request.getPage(), request.getRows(),request.getRealName(),request.getSpreandName(),request.getType(),request.getMobile(),request.getState());
	...
	public static class getUserRequest{
		...
		public String getSpreandName() {
			return spreandName;
		}
		public void setSpreandName(String spreandName) {
			this.spreandName = spreandName;
		}
