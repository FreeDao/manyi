...
public class CustServServiceImpl extends BaseService implements CustServService, custConstants{
	...
	public Response getSingle(CSSingleRequest css){
		...
		Query query = getEntityManager().createNativeQuery(
				...
				+ "Town.areaId TownAreaId, Town.name TownName, City.areaId CityAreaId, City.name CityName from "
				+ "Area Estate inner join Area Town  on Estate.parentId=Town.areaId inner join Area City  on Town.parentId=City.areaId WHERE Estate.areaId=:areaId  "
				);
