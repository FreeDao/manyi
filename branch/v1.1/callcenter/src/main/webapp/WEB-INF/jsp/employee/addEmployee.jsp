	...
	<script type="text/javascript">
		...
		var data_from = $('#mainfrom').datagrid({
			...
			columns : [ [ 
					...
					/* , {field : 'areaName',title : '城市',align : 'center',resizable : true,hidden : false,sortable : false,width:$(this).width() * 0.1}
					, {field : 'cityName',title : '区域',align : 'center',resizable : true,hidden : false,sortable : false,width:$(this).width() * 0.1} */
