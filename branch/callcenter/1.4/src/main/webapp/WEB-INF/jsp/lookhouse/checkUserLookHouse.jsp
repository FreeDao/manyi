             ...
             <table cellpadding="5">
                ...
                <tr>
                	<td colspan="2" style="width:300px;">
                		<div  style="display: none;">总层高:
                		<input class="easyui-numberbox" min='1' max='10000' maxlength="4" type='text' id="layers" name="layers" style="width:150px;"/> 
                		</div>
...
function submitCheck(){
	...
	$.ajax({ 
		...
		data: "id=" + userTaskIdSubmit + "&status=" + status + "&layers=" + layers + "&note=" + note ,
		dataType: "json", 
...
//加载     装修信息
function loadHouseSuppoert (houseId) {
	$.ajax({ 
        type: "post", 
        url: "${ctx}/sourcemanage/getHouseSuppoert",
        data: "houseId=" + houseId,
        dataType: "json", 
        success: function (data) {
...
//		装修情况：
		...
		if (data.houseSupporting.decorateTypeStr == "精装") {
	//		基础配套：
