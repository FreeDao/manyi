       	 	...
       	 	<td>
       	 		...
       	 		<c:forEach items="${building.images}" var="image">
       	 			<c:if test="${image.type == 3}">
								...
								<div id="change_mailbox_${image.orderNum }" class="change-demo" args="${image.orderNum }" idNum="${image.id }">
									<div>id:${image.id }</div>
									<div><img alt="" src="${image.imgKeyStr}" style="height:160px;width:160px"></img></div>
       	 	...
       	 	<td>
       	 		...
       	 		<c:forEach items="${building.images}" var="image">
       	 			<c:if test="${image.type == 4}">
								...
								<div id="change_elevator_${image.orderNum }" class="change-demo" args="${image.orderNum }" idNum="${image.id }">
									<div>id:${image.id }</div>
									<div><img alt="" src="${image.imgKeyStr}" style="height:160px;width:160px"></img></div>
