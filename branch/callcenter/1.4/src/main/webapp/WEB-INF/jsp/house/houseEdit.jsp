       	 	...
       	 	<td>
       	 		...
       	 		<c:forEach items="${house.images}" var="image">
       	 			<c:if test="${image.type == 'livingRoom'}">
								...
								<div id="change_${image.orderId }" class="change-demo" args="${image.orderId }" idNum="${image.id }">
									<div>id:${image.id }</div>
       	 	...
       	 	<td>
       	 		...
       	 		<c:forEach items="${house.images}" var="image">
       	 			<c:if test="${image.type == 'bedRoom'}">
								...
								<div id="change_bedRoom_${image.orderId }" class="change-demo" args="${image.orderId }" idNum="${image.id }">
									<div>id:${image.id }</div>
									<div><img alt="" src="${image.imgKeyStr}" style="height:160px;width:160px"></img></div>
       	 	...
       	 	<td>
       	 		...
       	 		<c:forEach items="${house.images}" var="image">
       	 			<c:if test="${image.type == 'wc'}">
								...
								<div id="change_wc_${image.orderId }" class="change-demo" args="${image.orderId }" idNum="${image.id }">
									<div>id:${image.id }</div>
									<div><img alt="" src="${image.imgKeyStr}" style="height:160px;width:160px"></img></div>
