...
import com.manyi.fyb.callcenter.user.controller.UserManagerController;
import com.manyi.fyb.callcenter.user.controller.UserManagerController.UserUpdateRequest;
...
//	private Map<String ,TokenModel<UserRequest>> addUser = new HashMap<String ,TokenModel<UserRequest>>();
	...
	public String getUser(HttpServletRequest request,GetUserRequest userRequest){
		return HttpClientHelper.sendRestJsonShortObj2Str("/userManager/getUser.rest", userRequest);
	}
...
//		}
	 ...
	 *
	 */
	@RequestMapping("/updateUserForBD")
	@ResponseBody
	public JSONObject updateUserForBD(HttpServletRequest request,UserUpdateRequest pars){
		JSONObject json = HttpClientHelper.sendRestInterShortObject("/userManager/updateUser.rest", pars);
		System.out.println(json);
		return json;
	}
	@Data
