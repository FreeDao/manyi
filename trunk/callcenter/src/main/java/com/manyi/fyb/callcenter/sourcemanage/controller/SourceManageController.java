...
public class SourceManageController extends BaseController {
	 ...
	 * 获得缩略图 图片
	 */
	@RequestMapping("/getHouseImage")
	@ResponseBody
	private String getHouseImage(SourceManageRequest sourceManageRequest) {
		
		return HttpClientHelper.sendRestJsonShortObj2Str("/sourcemanage/getHouseImage.rest", sourceManageRequest);
	}
	 ...
	 * 获得装修情况
	 */
	@RequestMapping("/getHouseSuppoert")
	@ResponseBody
	private String getHouseSuppoert(SourceManageRequest sourceManageRequest) {
		
		return HttpClientHelper.sendRestJsonShortObj2Str("/sourcemanage/getHouseSuppoert.rest", sourceManageRequest);
	}
	 ...
	 * 返回任务完成时间和位置信息
	 */
	@RequestMapping("/getBdtaskFinishAndLBS")
	@ResponseBody
	private String getBdtaskFinishAndLBS(SourceManageRequest sourceManageRequest) {
		
		return HttpClientHelper.sendRestJsonShortObj2Str("/sourcemanage/getBdtaskFinishAndLBS.rest", sourceManageRequest);
	}
