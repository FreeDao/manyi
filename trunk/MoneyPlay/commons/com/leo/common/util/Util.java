...
public abstract class Util {
	 ...
	 * @param s 待拆分的字符串
	 * @param sep 分隔符
	 * @return 如果字符串为null,空串或者只有一个spe的串,则都返回长度为0的String[]; <br/>此方法不会返回null,故外部无需判断null
	 */
	 ...
	 * @param s 待拆分的字符串
	 * @param sep 分隔符
	 * @return 如果字符串为null,空串或者只有一个spe的串,则都返回长度为0的int[]; <br/>此方法不会返回null,故外部无需判断null
	 */
