...
/**
 * 解释excel file(2007+,即xlsx文件，对于上万数据的文件，性能待优化.)
 * @author berlinluo
 * 2014年6月18日
 */
public class ExcelFileParseUtil extends DefaultHandler{
    ...
    * @throws IOException
	...
	public void endDeal() {
		...
		if (lastColumnNumber == -1) {
			...
			m = lastColumnNumber + 1;
		}
		for (int i = m; i < thisColumn; ++i) {
			rowlist.add("  ");
		}
   ...
   public static void main(String[] args) throws Exception {
	   ...
	   ExcelFileParseUtil excel = new ExcelFileParseUtil();
        ...
        excel.setPath("E:/temp/area_data.xlsx");
        ...
        System.out.println("==================start print all content of excel=================\n");
        for(int i=1;i<datas.size();i++){        	
        	 //System.out.println("Row"+i+"content is:");
        	 int cellSize = datas.get(i).size();
        		...
        		//System.out.print(datas.get(i).get(j));
        		 if(j<cellSize-1){
        			//System.out.print(" *** ");
        			 ...
        			 String lon = datas.get(i).get(2).trim();//经度第3列
        				String lat = datas.get(i).get(3).trim();//纬度第4列
        				String geoHash= null;
        ...
        System.out.println("\n==================finish print all content of excel, total line="+rowSize+" =================");
