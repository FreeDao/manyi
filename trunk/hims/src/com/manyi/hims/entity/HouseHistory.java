 ...
 */
@Entity
@Table(indexes = { @Index(name = "mainOwnerId", columnList = "mainOwnerId") })
@Cacheable
...
public class HouseHistory implements Serializable {
	...
	@GeneratedValue(strategy = TABLE, generator = "HouseHistory")
	@TableGenerator(name = "HouseHistory", allocationSize = 1)
	...
	@Getter @Setter private int picNum;
