...
import com.manyi.hims.sell.controller.SellRestController;
import com.manyi.hims.sell.controller.SellRestController.IndexRequest;
...
public class RentRestController extends RestController {
	...
	public DeferredResult<Response> indexList(HttpSession session,@RequestBody IndexRequest params) {
		final List<HouseEntity> entitys = this.rentService.indexList(params.getCityId());
