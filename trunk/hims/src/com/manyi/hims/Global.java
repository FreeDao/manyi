...
public enum Global {
	...
	public final static int DETAIL_DAY_LIMIT_INNER;

	public final static int DETAIL_MONTH_LIMIT_INNER;
	/************************************** 经纪人查看日限月限 ***********************************************/
	/************************************** 开放状态开关及级别 ***********************************************/
	public final static int OPEN_STATUS_FLAG;
	...
	public final static int ESTATE = 4;
	
	public final static Map<Integer,Integer> levelMap = new HashMap<Integer,Integer>();
	/************************************** 经纪人查看日限月限 ***********************************************/
	...
	static {
		...
		OPEN_STATUS_FLAG = Config._get("I_constants.openStatusFlag");
		
		DETAIL_DAY_LIMIT_INNER = Config._get("I_constants.detailDayLimitInner");
		DETAIL_MONTH_LIMIT_INNER = Config._get("I_constants.detailMonthLimitInner");
		
		levelMap.put(5, COUNTY);
		levelMap.put(10, PROVINCE);
		levelMap.put(15, CITY);
		levelMap.put(20, TOWN);
		levelMap.put(25, ESTATE);
