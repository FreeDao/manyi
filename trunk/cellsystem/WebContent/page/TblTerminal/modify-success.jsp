			...
			var crForm = {
				...
				init : function() {
				    ...
				    this.mainform.ligerForm({ 
				        ...
				        fields : [
				                  {name:"tblTerminal.did",type:"hidden"},
							...
							{display:"状态",name:"dstatus",type:"select",comboboxName:"dstatusName",options:{valueFieldID:"tblTerminal.dstatus",selectBoxHeight:60,data:LG.statusTypeData}}
				   ...
				   if (LG.getQueryStringByName("id")) {
						this.mainform.attr("action", "update.do?id="+id);
						this.loadForm();
				   } else {
