		...
		<div class="detail-middle l-form" style="margin-left: 30px; padding-bottom:100px; height:700px;">
			...
			<table id="detail" class="detail-tableSkin detail-tableSkinA">
				...
				<tr>
					...
					<th>上传人：</th>
					<td class="duploadperson" width="200"></td>
				</tr>
				<tr>
					<th>上传时间：</th>
				...
				<!-- 
					<th>支持终端：</th>
					<td class='dtermainal' type='select'>
					</td>
				 -->
				 	<%
				 ...
				 <th>关联的考卷:</th>
				 <td colspan="3">
				 	<%=categoryname %> >> <%=papername %>
				 </td>
				 	<%} %>
				</tr>
				<tr>
					<th>海报地址：</th>
					<td class="dplacardurl" colspan="3"></td>
				</tr>
				<!-- 
				<tr>
					<th>缩略图地址：</th>
				...
				<tr id="vod">
					<th>视频地址：</th>
					<td colspan="3" class='dvodurl'>
					</td>
				</tr>
				<tr >
					<th>描述信息：</th>
					<td colspan="3" class="ddesc">
					</td>
				</tr>
			</table>
		...
		var loadDt=null;
			var crForm = {
				...
				callback : function(data) {
					data = data|| {};
					var loadDt=data;
					selectdata=[{"data":[{'id':1,'text':'图文'},{'id':2,'text':'视频'}],id:"dtype"}
									 ,{'data':[{'id':1,'text':'电视'},{'id':5,'text':'移动设备'},{'id':10,'text':'电脑/PC'}],id:'dtermainal'}
					...
					if(loadDt.dtype==1){
						...
						$("#video").remove();
						$("#vod").remove();
						var vodurl ="http://"+$("#ftpip").val()+"/"+loadDt.dplacardurl; 
						var str="<div style='font-size: 16px; font-weight: bold;'>标题:"+loadDt.dname+"</div><hr/>";
						...
						//视频
						var vodurl ="http://"+$("#ftpip").val()+"/"+loadDt.dvodurl; 
						var flashvars={
							f:vodurl,//视频地址
