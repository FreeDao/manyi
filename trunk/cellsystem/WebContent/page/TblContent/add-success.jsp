			...
			<table id="detail" class="detail-tableSkin detail-tableSkinB">
				<tr>
					...
					<td colspan="3" width="800px">
						...
						<input type='hidden' name="tblContent.daction" value="0" />
					</td>
				</tr>
				<tr>
					<th>类型：</th>
				...
				<tr>
					<th>描述信息：</th>
					<td colspan="3">
						<textarea class="l-textarea" style="width: 410px"  name="tblContent.ddesc" rows="3"  validate="{'maxlength':30}"></textarea>
					</td>
				</tr>
		...
		var attributes={id:'ckplayer_a1',name:'ckplayer_a1',menu:'false'};
			...
			var crForm = {
				...
				add : function() {
					...
					//$("#result").load('<%=path%>/FTPFileList/ftplist.do?type='+filetype+'&_dt='+d);
