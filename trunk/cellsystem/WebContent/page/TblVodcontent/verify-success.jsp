			...
			var crForm = {
				...
				verify : function(item){
					...
					$.ajax({
						async:false,
						data:{'id':<%=id%>},
						url:"<%=path%>/TblVodcontent/verifyContent.do?_t="+_t,
						dataType:"json",
						success:function(data){
							if(!data.iserror){
