...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="mainform" class="addEditManiForm" method="post" action="save.do" style="margin-left: 30px;">
			...
			var crForm = {
				...
				init : function() {
				    ...
				    this.mainform.ligerForm({ 
				        ...
				        fields : [
							{name:"tblCategory.did",type:"hidden",id:"id"},
							{display:"栏目名称",name:"tblCategory.dname",validate:{required:true,maxlength:64},group:"基本信息",groupicon:groupicon},
							//{display:"栏目编号",name:"tblCategory.dcode",validate:{required:true,rangelength:[3,10]}},
							{display:"父节点",name:"dparentid",type:"select",comboboxName:"dparentidName",options:{valueFieldID:"tblCategory.dparentid",data:dparentidTypeData}},
							{display:"栏目类型",name:"dtype",type:"select",comboboxName:"dtypeName",options:{valueFieldID:"tblCategory.dtype",data:dtypeData}},
							//{display:"是否为父节点",name:"dhaschild",type:"select",comboboxName:"dhaschildName",options:{valueFieldID:"tblCategory.dhaschild",data:LG.haschildTypeData}},
							//{display:"支持的终端",name:"dtermainal",type:"select",comboboxName:"dtermainalName",options:{valueFieldID:"tblCategory.dtermainal",data:LG.dtermainalData}},
							...
							{display:"状态",name:"dstatus",type:"select",comboboxName:"dstatusName",options:{valueFieldID:"tblCategory.dstatus",selectBoxHeight:60,data:LG.statusTypeData}}
						],
