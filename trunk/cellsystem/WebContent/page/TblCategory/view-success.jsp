	...
	<body>
		<div class="detail-middle l-form" style="margin-left: 30px;">
			...
			<table id="detail" class="detail-tableSkin detail-tableSkinA">
				...
				<tr>
					<th>栏目类型：</th>
					<td class="dtype" type='select'></td>
				</tr>
				
				<!-- 
				<tr>
					<th>支持终端：</th>
					<td class="dtermainal" type='select'></td>
				</tr>
				 -->
				 
				<tr>
					<th>上线时间：</th>
					<td class="duploaddate" type='date'></td>
				</tr>
				<tr>
					<th width="90">下线时间：</th>
					<td class="dupdowndate" type='date'></td>
				</tr>
				<tr>
					<th>状态：</th>
					...
					for ( var p in data) {
						...
						if (ele.length > 0) {
							if(ele.attr('type')){
								...
								}else if(ele.attr('type') == 'date'){
									ele.html(data[p].split(" ")[0]);
								}
							}else{
