	...
	<body>
		...
		<script type="text/javascript">
			var crForm = {
				...
				init : function() {
				    ...
				    this.mainform.ligerForm({ 
				        ...
				        fields : [
							...
							{display:"状态",name:"dstatus",newline:true,type:"select",comboboxName:"MMType",options:{valueFieldID:"tblEpginfo.dstatus",selectBoxHeight:60,data:LG.statusTypeData,value:1}}
						],
				...
				loadForm : function() {
					LG.loadForm(this.mainform, {url:"<%=path %>/TblEpginfo/loadModify.do?id="+id},function(){});
				}
			}
			crForm.init();
		</script>
