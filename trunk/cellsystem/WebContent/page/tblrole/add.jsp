				...
				init : function() {
				    ...
				    this.mainform.ligerForm({ 
				        ...
				        fields : [
							...
							{display:"角色名称",name:"dname",space:160,newline:false,labelWidth:LG.labelWidthB,validate:{REQUERELENGTH:[1,16]},group:"基本信息",groupicon:groupicon},
							{display:"类型",name:"dtype",space:160,newline:false,type:"select",comboboxName:"MType",options:{valueFieldID:"dtype",data:[{text:'云平台角色',id:1},{text:'企业角色',id:2}],value:1}},
							{display:"状态",name:"dstatus",space:160,newline:false,type:"select",comboboxName:"MMType",options:{valueFieldID:"dstatus",selectBoxHeight:60,data:LG.statusTypeData,value:1}},
							{display:"描述",name:"ddesc",type:"textarea",labelWidth:LG.labelWidthB,width:LG.inputWidthD,validate:{LENGTH1:[0,16]}}
						],
				...
				add : function() {
					if (window.win) {
						...
						this.wingrid = gridPanle.ligerGrid( {
							columns: [
								{display:"登录名",name:"AA",width:120},
								{display:"真实姓名",name:"BB",width:120},
								{display:"性别",name:"SEX",width:120,render: LG.sex},
								{display:"部门",name:"DD",width:120},
								{display:"邮箱",name:"EE",width:120},
								{display:"状态",name:"MM",width:120,render: LG.status}
						   ],
						...
						window.win = $.ligerDialog.open( {
							title : "选择操作员", width:640,height:370,top:50,
