...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		...
		<script type="text/javascript">
			...
			var roleListData=<%=request.getAttribute("roleListData")%>;
		</script>
</head>
<body>
		...
		<script type="text/javascript">
				...
				init : function() {
				    ...
				    this.mainform.ligerForm({ 
				        ...
				        fields : [
							...
							{name:"tblPermissiongroup.did",type:"hidden"},
							{display:"权限组名称",name:"tblPermissiongroup.dname",space:LG.spaceWidthB,newline:false,validate:{REQUERELENGTH:[1,16]},group:"基本信息",groupicon:groupicon},
							{display:"状态",name:"dstatus",newline:false,labelWidth:LG.labelWidthA,type:"select",comboboxName:"MMType",options:{valueFieldID:"tblPermissiongroup.dstatus",selectBoxHeight:60,data:LG.statusTypeData}},
							{display:"描述",name:"tblPermissiongroup.ddesc",type:"textarea",width:LG.inputWidthG,validate:{LENGTH1:[0,16]}}
						],
				...
				loadForm : function() {
					LG.loadForm(this.mainform, {url:"loadModify.do?id="+id,preID:'tblPermissiongroup\\.'},function(){});
				}
			}
			crForm.init();
				...
				add : function() {
					...
					if (window.win) {
						window.win.show();
				  		...
				  		self = this;
						var panle = $("<div></div>");
						var gridPanle = $("<div id='abc' style='width:700px;height:300px'></div>");
