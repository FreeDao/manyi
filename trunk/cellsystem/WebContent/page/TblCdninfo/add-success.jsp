				...
				init : function() {
				    ...
				    this.mainform.ligerForm({ 
				        ...
				        fields : [
							...
							{display:"状态",name:"dstatus",newline:true,type:"select",comboboxName:"MMType",options:{valueFieldID:"tblCdninfo.dstatus",selectBoxHeight:60,data:LG.statusTypeData,value:1}}
						],
