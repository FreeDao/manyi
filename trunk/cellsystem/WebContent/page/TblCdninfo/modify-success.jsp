			...
			var crForm = {
				...
				init : function() {
				    ...
				    this.mainform.ligerForm({ 
				        ...
				        fields : [
				        	{name:"tblCdninfo.did",type:"hidden"},
							{display:"名称",name:"tblCdninfo.dcdnname",newline:false,group:"基本信息",groupicon:groupicon,validate:{REQUERELENGTH:[1,32]}},
							{display:"URL",name:"tblCdninfo.durl",newline:true,validate:{required:true,url:true}},
							{display:"状态",name:"dstatus",newline:true,type:"select",comboboxName:"MMType",options:{valueFieldID:"tblCdninfo.dstatus",selectBoxHeight:60,data:LG.statusTypeData}}
						],
				...
				loadForm : function() {
					LG.loadForm(this.mainform, {url:"<%=path%>/TblCdninfo/loadModify.do?id="+id,preID:'tblCdninfo\\.'},function(){});
				}
			}
			crForm.init();
		</script>
