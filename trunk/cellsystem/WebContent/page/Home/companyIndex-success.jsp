		...
		<div class="detail-middle l-form" style="margin-left: 30px;">
			...
			<b class="topCor-1"></b>
				...
				<div class="i-item">
					...
					<div id='datatype1' style='display:none;'>category</div>
				</div>
				<div class="l-clear"></div>
			</div>
			...
			<b class="topCor-1"></b>
				...
				<div class="i-item">
					...
					<div id='datatype5' style='display:none;'>category</div>
				</div>
				<div class="l-clear"></div>
			</div>
			...
			<b class="topCor-1"></b>
				...
				<div class="i-item">
					...
					<div id='datatype6' style='display:none;'>category</div>
				</div>
				<div class="l-clear"></div>
			</div>
					...
					function(data){
							...
							for(var j = 0; j < rows.length ; j++){
								...
								if(rows[j].type == 'text'){
									...
									$("#showaffiche").show();
									$("#btn0").html("修改");
								}else if(rows[j].type == 'logo'){
								}else if(rows[j].type == 'nav'){
									var i=row.sequence;
