...
public class TblRole implements java.io.Serializable{
	...
	//alias
	public static final String TABLE_ALIAS = "TblRole";
	...
	@Column(name = "D_TYPE", unique = false, nullable = true, insertable = true, updatable = true, length = 10)
	...
	public boolean equals(Object obj) {
		if(obj instanceof TblRole == false) return false;
		if(this == obj) return true;
		TblRole other = (TblRole)obj;
